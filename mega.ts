...
const embed_url = "https://megacloud.tv/embed-1/e-1/";
const referrer = "https://2kmoviehd.to/";
...
const canvas = {
  baseUrl: "https://megacloud.tv/embed-1/e-1/POg3BzgJJ55W?z=",
  width: 0,
  height: 0,
  style: {
    style: {
...
const fake_window: fakeWindow = {
  ...
  location: {
    href: "https://megacloud.tv/embed-1/e-1/POg3BzgJJ55W?z=",
    origin: "https://megacloud.tv",
  },
  performance: {
    timeOrigin: dateNow,
...
const nodeList = {
  image: {
    src: "https://megacloud.tv/images/image.png?v=0.0.7",
    height: 50,
    width: 65,
    complete: true,
  },
...
let script_url = "https://megacloud.tv/embed-1/e-1/POg3BzgJJ55W?z=";
...
const V = async () => {
  let Q0 = await wasmLoader('https://megacloud.tv/images/loading.png?v=0.7');
  try {
    wasmLoader.greet();
  } catch (error) {
